...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Aggregate Section 3 benchmark results")
    parser.add_argument("--input-root", default="data/section3")
...
def main() -> None:
    ...
    if not rows:
        raise FileNotFoundError(f"No Section 3 result files found under {input_root}")
